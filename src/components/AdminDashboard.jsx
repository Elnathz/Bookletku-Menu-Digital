...
// Jangan lupa tambahkan import icons di bagian atas file:
// import { MapPin, Clock, Phone, Palette, Check } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        {/* Notification */}
        {notification && (
          <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg text-sm">
            {notification}
          </div>
        )}
